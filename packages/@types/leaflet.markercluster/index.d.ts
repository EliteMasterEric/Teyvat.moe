...
declare module 'leaflet' {
  ...
  interface MarkerClusterGroupOptions extends LayerOptions {
    /**
     * ERIC: I wanted spiderfy to show the original cluster points.
     * To do this, I needed to modify spiderfyShapePositions to provide the childMarkers.
     */
    spiderfyShapePositions?: (count: number, centerPt: L.Point, childMarkers: Marker[]) => Point[];
    /**
     * ERIC: I wanted to add an option to redo spiderfying on every zoom.
     */
