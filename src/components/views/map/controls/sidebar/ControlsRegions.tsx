...
import { getMapRegion, MapRegionKeys } from 'src/components/data/map/MapRegions';
import {
...
import ControlsRegionBanner from 'src/components/views/map/controls/sidebar/ControlsRegionBanner';
