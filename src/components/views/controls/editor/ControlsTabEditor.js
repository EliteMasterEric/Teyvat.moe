...
import { clearEditorData } from '~/components/redux/ducks/editor';
...
const _ControlsTabEditor = ({ displayed, editorData, resetTab, clearEditorData }) => {
...
const ControlsTabEditor = connect(mapStateToProps, mapDispatchToProps)(_ControlsTabEditor);
